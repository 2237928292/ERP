<template>
  <div class='box_s'>
    <div class="KPITable">
        ...
        <tbody>
          <tr>
            ...
            <td colspan="6" style="lineHeight:40px">
              <h3>{{DateStr}}售后员工考核表</h3>
            </td>
          </tr>
          <tr>
            <td>姓名</td>
            <td colspan="2" class="DJCCXXRY" @click="SelectPersonnel()">
              {{this.AddKpi.EmployeeName ? this.AddKpi.EmployeeName : '点击此处选择人员' }}
          ...
          <tr>
            ...
            <td>
              <el-input-number v-model="AddKpi.Pone" size="mini" :min="-100" :max="0" @change="InitialCoreCalc()"></el-input-number>
            </td>
            <td>
          ...
          <tr>
            ...
            <td>
              <el-input-number v-model="AddKpi.Ptwo" size="mini" :min="-100" :max="0" @change="InitialCoreCalc()"></el-input-number>
            </td>
            <td>
          ...
          <tr>
            ...
            <td>
              <el-input-number v-model="AddKpi.Pthree" size="mini" :min="-100" :max="0" @change="InitialCoreCalc()"></el-input-number>
            </td>
            <td>
          ...
          <tr>
            ...
            <td>
              <el-input-number v-model="AddKpi.Pfour" size="mini" :min="-100" :max="0" @change="InitialCoreCalc()"></el-input-number>
            </td>
            <td>
          ...
          <tr>
            ...
            <td>
              <el-input-number v-model="AddKpi.Pfive" size="mini" :min="-100" :max="0" @change="InitialCoreCalc()"></el-input-number>
            </td>
            <td>
          ...
          <tr>
            ...
            <td>
              <el-input-number v-model="AddKpi.Psix" size="mini" :min="-100" :max="0" @change="InitialCoreCalc()"></el-input-number>
            </td>
            <td>
      ...
      <el-button type="primary" style="float:right;marginTop:30px" :loading="this.$store.state.Vuex.loading" size="mini" @click="InitialCoreFun()">初核</el-button>
...
export default {
  ...
  methods: {
    //   InitialCoreFun
    InitialCoreFun: function () {
      var obj = {
        api: "post",
        url: this.$store.state.http + "PCenter/AddKpi",
        data: this.AddKpi,
      };
    ...
    Choose: function (er) {
      console.log(er);
      this.AddKpi.EmployeeId = er.EmployeeId;
      this.AddKpi.EmployeeName = er.Name;
  ...
  created() {
    var date = new Date();
    this.DateStr =
      date.getFullYear() + "年" + (Number(date.getMonth()) + 1) + "月";
    this.AddKpi.Date = date.getFullYear() + "-" + (Number(date.getMonth()) + 1);
    console.log(this.AddKpi.Date);
  },
  // 生命周期 - 挂载完成（可以访问DOM元素）
  mounted() {
    //   选择人员
