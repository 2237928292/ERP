<template>
  <div class="box_s">
    ...
    <div class="demo">
      <div>内部编码:</div>
      <el-input v-model="Product.BarcodeMemo" maxlength="16" size="mini"></el-input>
    </div>
    ...
    <div class="demo">
      ...
      <el-row class="demo-autocomplete">
        <el-col>
          <el-autocomplete size='mini' class="inline-input input" @select="handleSelect" v-model="Product.Manufacturer" :fetch-suggestions="querySearch" @input="BuyingUnitPriceOnclick" placeholder="请输入内容">
          </el-autocomplete>
        </el-col>
      </el-row>
    </div>
    ...
    <div class="demo">
      <div>年份:</div>
      <el-date-picker style="width:180px" v-model="Product.ProductionYear" type="year" size="mini" value-format="yyyy" placeholder="选择年"></el-date-picker>
    </div>
    <!-- 保质期 -->
    <div class="demo">
      <div>保质期:</div>
...
export default {
  ...
  methods: {
    ...
    add: function () {
      ...
      //  if (this.Product.BarcodeMemo == "") {
      //     return this.$msgs(1, "请输入内部编码！");
      //   } else if (this.Product.BarcodeMemo.split(" ").length != 1) {
      //     return this.$msgs(1, "内部编码不可包含空格！");
      //   } else if (this.Product.BarcodeMemo.length != 16) {
      //     return this.$msgs(
      //       1,
      //       "内部编码必须为16位！,还差" +
      //         (16 - this.Product.BarcodeMemo.length) +
      //         "位！"
      //     );
      //   }
